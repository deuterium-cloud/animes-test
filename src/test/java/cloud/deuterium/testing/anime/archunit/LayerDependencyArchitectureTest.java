...
@AnalyzeClasses(packages = {
        "cloud.deuterium.testing.anime.config",
...
public class LayerDependencyArchitectureTest {
    ...
    @ArchTest
    static final ArchRule services_should_only_depend_on_persistence_or_config_or_other_services =
            classes().that().resideInAPackage("..service..")
                    .should().onlyDependOnClassesThat().resideInAnyPackage("..service..", "..config..",
                            "..repository..", "java..", "javax..", "org..", "..model..");
